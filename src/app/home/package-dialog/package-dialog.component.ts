...
export class PackageDialogComponent implements OnInit, AfterViewInit {
  ...
  private bothprice: string = ''
  private errorServicePackName: string = ''
  private errorImg: string = ''
  private errorTasks: string = ''
  private errorRemark: string = ''
  private errorOldPrice: string = ''
  ...
  save() {
    ...
    for (var i = 0; i < mission.length; i++) {
      let tmpMissionName = mission[i].missionName
      for (var j = i + 1; j < mission.length; j++) {
